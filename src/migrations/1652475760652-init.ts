...
export class init1652475760652 implements MigrationInterface {
    name = 'init1652475760652'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "dishes" ADD CONSTRAINT "FK_9491dfcdc274899d7c73722987b" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "categories" ADD CONSTRAINT "FK_d537a93225b779e9ef8f5598c5a" FOREIGN KEY ("menuId") REFERENCES "menus"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
